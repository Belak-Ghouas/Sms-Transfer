...
class HomeAdapter(private val onClick :((service: AppletUi)->Unit)?= null,
                  private val headerData:List<AppletType>,
                  private val onHeaderClick:Visitor?=null) : RecyclerView.Adapter<RecyclerView.ViewHolder >() {
    ...
    class HeaderViewHolder( private val binding: ViewPagerHeaderBinding ,private val visitor: Visitor?)
